...
const WEEKLY_MESSAGES = [
  {
    he: "תקוע/ה על תרגיל? נסה/י להסביר אותו במילים שלך לחבר - אם אתה יכול/ה להסביר, אתה יודע/ת.",
    ar: "واقف عند تمرين؟ جرّب تشرحه لصاحبك بكلماتك - إذا قدرت تشرح، معناته فهمت.",
  },
  {
    he: "10 דקות תרגול ביום עוזרות יותר משעה אחת בשבוע - עקביות קצרה עדיפה על מרתון נדיר.",
    ar: "10 دقايق تمرين باليوم بتساعد أكتر من ساعة وحدة بالأسبوع - ثبات قصير أحسن من ماراثون نادر.",
  },
  {
    he: "לפני שמבקשים עזרה, כדאי לנסות לפתור לבד קודם - זה מה שבאמת מחזק את ההבנה.",
    ar: "قبل ما تطلب مساعدة، جرّب تحل لحالك الأول - هاد يلي بيقوّي الفهم فعلاً.",
  },
  {
    he: "טעות בתרגיל היא הזדמנות להבין למה, לא רק לתקן את התוצאה.",
    ar: "الغلط بتمرين هو فرصة تفهم ليش، مش بس تصحح النتيجة.",
  },
  {
    he: "קריאה איטית של השאלה, פעמיים, מונעת הרבה טעויות - לפני שממהרים לפתור.",
    ar: "قراءة السؤال ببطء، مرتين، بتمنع كتير أغلاط - قبل ما تستعجل بالحل.",
  },
];
